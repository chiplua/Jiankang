 ...
 */
public class ChildRearingListViewSecondAdapter extends BaseAdapter{
    private static final String TAG = "ChildRearingListViewSecondAdapter";
    ...
    public ChildRearingListViewSecondAdapter(Context context, List<Map<String, Object>> listItems) {
        mContext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                detailID = SQLOperation.getChildRearingRelationMapOutlineID(selectName);
                Log.d(TAG, "detailID is " + detailID);

                Intent intentCommon = new Intent();
                intentCommon.putExtra("selectName", selectName);
                intentCommon.setClass(mContext, ChildRearingCommonDetailActivity.class);
